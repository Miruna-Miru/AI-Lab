...
# Directly call the functions to input the boards and solve the puzzle
initial_board = get_input_board("Enter the initial board : ")
goal_board = get_input_board("Enter the goal board : ")
